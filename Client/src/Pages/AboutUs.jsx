                ...
                <div className="flex  flex-col lg:flex-row items-center gap-5 mx-10">
                    <section className="lg:w-1/2 space-y-10">
                        ...
                        <p className=" text-xl text-gray-200">
                            Our goal is to provide affordable, high-quality education to the world. We offer a platform for aspiring teachers and students to share their skills, creativity, and knowledge with one another, fostering empowerment and contributing to the growth and well-being of humanity.
                        </p>
                    </section>
